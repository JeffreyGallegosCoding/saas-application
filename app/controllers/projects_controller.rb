class ProjectsController < ApplicationController
  ...
  def create
    ...
    # user creating the project is automatically added to project via user_projects association
  ...
  # verify a tenant so that only tenants working on the project they have access to can look at the project
  def verify_tenant
    unless params[:tenant_id] == Tenant.current_tenant_id.to_s
      redirect_to :root, flash: { error: "You are not authorized to access other organization info" }
    end
  end
